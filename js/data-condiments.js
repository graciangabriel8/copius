...
{id:"aceto-balsamico-tradizionale",cat:"condiments",parent:"balsamic",sign:"DOP",luxe:true,price:4,pk:"600–1 200 €/L (flacon de 100 ml)",name:{en:"Aceto Balsamico Tradizionale DOP",fr:"Vinaigre balsamique traditionnel de Modène DOP"},latin:"Vitis vinifera",
...
{id:"aka-miso",cat:"condiments",parent:"miso",price:2,pk:"8–18 €/kg",name:{en:"Aka miso",fr:"Miso rouge (aka)"},latin:"Long-aged rice and soybean paste",
...
{id:"alaea-salt",cat:"condiments",parent:"salt",rare:true,price:2,pk:"20–45 €/kg",name:{en:"Alaea red Hawaiian salt",fr:"Sel rouge d’Hawaï (alaea)"},latin:"Natrii chloridum",
...
{id:"baek-kimchi",cat:"condiments",parent:"kimchi",price:2,pk:"8–15 €/kg",name:{en:"Baek-kimchi",fr:"Baek-kimchi"},latin:"Brassica rapa subsp. pekinensis",
...
{id:"bamboo-salt",cat:"condiments",parent:"salt",price:3,pk:"50–200 €/kg",name:{en:"Bamboo salt",fr:"Sel de bambou (jukyeom)"},latin:"Phyllostachys spp.",
...
{id:"bavarian-sweet-mustard",cat:"condiments",parent:"mustard",price:2,pk:"8–16 €/kg",name:{en:"Bavarian sweet mustard",fr:"Moutarde douce bavaroise"},latin:"Sinapis alba",
...
{id:"olive-cerignola",cat:"condiments",parent:"olive",price:2,pk:"12–22 €/kg",name:{en:"Bella di Cerignola olive",fr:"Olive Bella di Cerignola"},latin:"Olea europaea 'Bella di Cerignola'",
...
story:{en:"Bella di Cerignola is among the largest table olives on the market — its growers call it the biggest in the world, though no register ranks varieties that way. The specification puts each fruit between six and thirty grams, where a small Gaeta counts in the hundreds to the kilo. Its DOP is registered under a third name again, La Bella della Daunia, after the ancient name of the plain it grows on.",
fr:"La Bella di Cerignola compte parmi les plus grosses olives de table du marché — ses producteurs la disent la plus grosse du monde, même si aucun registre ne classe les variétés ainsi. Le cahier des charges fixe chaque fruit entre six et trente grammes, là où une petite olive de Gaète se compte par centaines au kilo. Son AOP porte encore un autre nom, La Bella della Daunia, d’après le nom antique de la plaine où elle pousse."},
...
pairs:["kome-koji","daikon","rice","junmai-sake","cucumber","salt"],
...
{id:"olive-castelvetrano",cat:"condiments",parent:"olive",price:2,pk:"14–25 €/kg",name:{en:"Castelvetrano olive",fr:"Olive Castelvetrano"},latin:"Olea europaea 'Nocellara del Belice'",
...
{id:"olive-cassee-baux",cat:"condiments",parent:"olive",rare:true,price:2,pk:"18–30 €/kg",name:{en:"Cracked olive of the Vallée des Baux",fr:"Olive cassée de la vallée des Baux"},latin:"Olea europaea 'Salonenque'",
...
pairs:["pork","pork-belly","beef","black-pepper","juniper","garlic"],
...
{id:"dark-soy-sauce",cat:"condiments",parent:"soy-sauce",price:1,pk:"5–10 €/L",name:{en:"Dark soy sauce",fr:"Sauce soja noire (lao chou)"},latin:"Glycine max",
...
{id:"dijon-mustard",cat:"condiments",parent:"mustard",price:1,pk:"4–9 €/kg",name:{en:"Dijon mustard",fr:"Moutarde de Dijon"},latin:"Brassica juncea",
...
{id:"english-mustard",cat:"condiments",parent:"mustard",price:2,pk:"25–45 €/kg",name:{en:"English mustard powder",fr:"Moutarde anglaise (en poudre)"},latin:"Brassica juncea / Sinapis alba",
...
{id:"maldon-flake-salt",cat:"condiments",parent:"salt",price:2,pk:"14–22 €/kg",name:{en:"Flake sea salt (Maldon)",fr:"Sel en flocons de Maldon"},latin:"Natrii chloridum",
...
{id:"olive-gaeta",cat:"condiments",parent:"olive",price:2,pk:"12–20 €/kg",name:{en:"Gaeta olive",fr:"Olive de Gaète"},latin:"Olea europaea 'Itrana'",
...
{id:"genmai-miso",cat:"condiments",parent:"miso",price:2,pk:"12–22 €/kg",name:{en:"Genmai miso",fr:"Miso de riz complet (genmai miso)"},latin:"Oryza sativa, Glycine max",
origin:{en:"Japan",fr:"Japon"},season:[],
...
{id:"olive-gordal",cat:"condiments",parent:"olive",price:2,pk:"8–15 €/kg",name:{en:"Gordal olive",fr:"Olive gordal"},latin:"Olea europaea 'Gordal Sevillana'",
...
{id:"sel-gris-guerande",cat:"condiments",parent:"salt",sign:"IGP",price:1,pk:"2–5 €/kg",name:{en:"Grey sea salt (sel gris)",fr:"Sel gris de Guérande"},latin:"Natrii chloridum marinum",
...
{id:"hatcho-miso",cat:"condiments",parent:"miso",price:2,pk:"25–40 €/kg",name:{en:"Hatchō miso",fr:"Hatchō miso"},latin:"Glycine max",
...
{id:"himalayan-pink-salt",cat:"condiments",parent:"salt",price:1,pk:"4–10 €/kg",name:{en:"Himalayan pink salt",fr:"Sel rose de l’Himalaya"},latin:"Natrii chloridum",
...
pairs:["butter","rice","junmai-sake","smoked-butter","mascarpone","kome-koji"],
...
{id:"olive-kalamata",cat:"condiments",parent:"olive",sign:"PDO",price:2,pk:"10–18 €/kg",name:{en:"Kalamata olive",fr:"Olive Kalamata"},latin:"Olea europaea 'Kalamon'",
...
{id:"koikuchi-shoyu",cat:"condiments",parent:"soy-sauce",price:1,pk:"5–12 €/L",name:{en:"Koikuchi shoyu",fr:"Sauce soja koikuchi"},latin:"Glycine max, Triticum aestivum",
...
{id:"kosher-salt",cat:"condiments",parent:"salt",price:1,pk:"3–8 €/kg",name:{en:"Kosher salt",fr:"Sel casher"},latin:"Natrii chloridum",
...
{id:"olive-lucques",cat:"condiments",parent:"olive",sign:"AOP",price:2,pk:"16–28 €/kg",name:{en:"Lucques olive",fr:"Olive lucques"},latin:"Olea europaea 'Lucques'",
...
{id:"mugi-miso",cat:"condiments",parent:"miso",price:2,pk:"15–30 €/kg",name:{en:"Mugi miso",fr:"Miso d’orge (mugi)"},latin:"Hordeum vulgare (fermented)",
...
{id:"olive-nyons",cat:"condiments",parent:"olive",sign:"AOP",price:2,pk:"18–30 €/kg",name:{en:"Nyons olive",fr:"Olive de Nyons"},latin:"Olea europaea 'Tanche'",
...
{id:"olive-picholine",cat:"condiments",parent:"olive",price:2,pk:"10–18 €/kg",name:{en:"Picholine olive",fr:"Olive picholine"},latin:"Olea europaea 'Picholine'",
...
{id:"nanru",cat:"condiments",parent:"furu",price:1,pk:"10–20 €/kg",name:{en:"Red fermented bean curd (nanru)",fr:"Tofu fermenté rouge (nanru)"},latin:"Glycine max",
...
{id:"saikyo-miso",cat:"condiments",parent:"miso",price:2,pk:"18–30 €/kg",name:{en:"Saikyo miso",fr:"Saikyo miso (miso blanc de Kyoto)"},latin:"Glycine max (fermented)",
...
{id:"saishikomi-shoyu",cat:"condiments",parent:"soy-sauce",price:2,pk:"25–45 €/L",name:{en:"Saishikomi shoyu",fr:"Sauce soja saishikomi (double brassage)"},latin:"Glycine max (double-brewed)",
...
{id:"salt-packed-capers",cat:"condiments",parent:"capers",price:2,pk:"40–70 €/kg",name:{en:"Salt-packed capers",fr:"Câpres au sel"},latin:"Capparis spinosa",
...
{id:"shiro-shoyu",cat:"condiments",parent:"soy-sauce",rare:true,price:3,pk:"14–24 €/L",name:{en:"Shiro shoyu",fr:"Sauce soja blanche (shiro)"},latin:"Triticum aestivum (fermented)",
...
{id:"smoked-salt",cat:"condiments",parent:"salt",price:2,pk:"12–25 €/kg",name:{en:"Smoked sea salt",fr:"Sel fumé"},latin:"Natrii chloridum",
origin:{en:"Northern Europe",fr:"Europe du Nord"},season:[],
...
{id:"olive-taggiasca",cat:"condiments",parent:"olive",price:3,pk:"18–30 €/kg",name:{en:"Taggiasca olive",fr:"Olive taggiasche"},latin:"Olea europaea 'Taggiasca'",
...
{id:"tamarind-paste",cat:"condiments",parent:"tamarin",price:1,pk:"6–12 €/kg",name:{en:"Tamarind paste",fr:"Pâte de tamarin"},latin:"Tamarindus indica",
...
{id:"olive-throuba",cat:"condiments",parent:"olive",rare:true,price:3,pk:"20–32 €/kg",name:{en:"Throuba Thassos olive",fr:"Olive throumba de Thassos"},latin:"Olea europaea",
...
{id:"usukuchi-shoyu",cat:"condiments",parent:"soy-sauce",price:2,pk:"8–15 €/L",name:{en:"Usukuchi shoyu",fr:"Sauce soja claire (usukuchi)"},latin:"Glycine max",
...
{id:"moutarde-violette-brive",cat:"condiments",parent:"mustard",rare:true,price:2,pk:"12–20 €/kg",name:{en:"Violet mustard of Brive",fr:"Moutarde violette de Brive"},latin:"Brassica nigra & Vitis vinifera",
...
{id:"wholegrain-mustard",cat:"condiments",parent:"mustard",price:1,pk:"5–10 €/kg",name:{en:"Wholegrain mustard",fr:"Moutarde à l’ancienne"},latin:"Brassica juncea",
...
{id:"moshio-salt",cat:"condiments",parent:"salt",rare:true,price:2,pk:"50–100 €/kg",name:{en:"Moshio seaweed salt",fr:"Sel d’algues moshio"},latin:"Sargassum fulvellum",
...
{id:"verjus-rouge",cat:"condiments",parent:"verjus",rare:true,price:2,pk:"12–22 €/L",name:{en:"Red verjuice",fr:"Verjus rouge"},latin:"Vitis vinifera",
...
{id:"olive-nice",cat:"condiments",parent:"olive",sign:"AOP",price:2,pk:"21–43 €/kg",name:{en:"Nice olive",fr:"Olive de Nice"},latin:"Olea europaea 'Cailletier'",
origin:{en:"Alpes-Maritimes, around Nice",fr:"Alpes-Maritimes, pays niçois"},season:[],
flavor:["fruity","mild","bitter","briny"],texture:["firm","smooth","moist"],
story:{en:"A jar runs from yellow-green to violet-black, and that mix is written into the specification: the tall, drooping Cailletier trees are picked in a single pass, so fruit from shaded and sunny branches comes in together. Within 24 hours the olives go into a brine of at most 12% salt, with nothing else added, and stay there at least three months, losing their bitterness slowly and taking on the prune, cherry and old-wine notes the specification describes.",
fr:"Un même bocal va du vert jaunâtre au noir violacé, et ce mélange est inscrit au cahier des charges : les grands cailletiers au port retombant se récoltent en un seul passage, si bien que les fruits des branches à l’ombre et au soleil arrivent ensemble. Dans les 24 heures, les olives passent dans une saumure à 12 % de sel au plus, sans rien d’autre, et y restent au moins trois mois : elles perdent lentement leur amertume et prennent les notes de pruneau, de cerise et de vieux vin que décrit le cahier des charges."},
tip:{en:"The specification names it the olive of the salade niçoise: add them whole, stalks and all, at the last moment. The flesh comes away easily from the stone, and the appellation also covers a pâte d'olive made of nothing but these olives and at most 12% Nice olive oil.",
fr:"Le cahier des charges en fait l’olive de la salade niçoise : ajoutez-les entières, avec leurs queues, au dernier moment. La chair se détache bien du noyau, et l’appellation couvre aussi une pâte d’olive faite de ces seules olives et d’au plus 12 % d’huile d’olive de Nice."},
pairs:["tomato","anchovy","tuna","egg","green-bean","radish","basil","olive-oil"],
svg:'<path class="s" d="M24 28q16 14 26 42"/><path class="f1 sf" d="M50 30q14-6 20 2-12 8-20-2Z"/><circle class="f3 sf" cx="33" cy="40" r="6"/><circle class="f2 sf" cx="43" cy="54" r="6"/><circle class="f3 sf" cx="51" cy="68" r="5"/>'},
{id:"olive-nimes",cat:"condiments",parent:"olive-picholine",sign:"AOP",price:2,pk:"26 €/kg",name:{en:"Nîmes olive",fr:"Olive de Nîmes"},latin:"Olea europaea 'Picholine'",
origin:{en:"Gard and eastern Hérault",fr:"Gard et est de l’Hérault"},season:[],
flavor:["buttery","nutty","salty","fresh"],texture:["crunchy","firm","juicy"],
story:{en:"Hand-picked from 1 September at the earliest, before its green begins to yellow, the Picholine is soaked in a potash or soda solution only until it is partly debittered, then kept at least 36 hours in water before a sea-salt brine. Stopping the lye early is the point: the specification credits the method with the crunch it scores above 3 on the International Olive Council scale, and with the butter and hazelnut it calls typical.",
fr:"Cueillie à la main à partir du 1er septembre au plus tôt, avant que son vert ne vire au jaune, la picholine macère dans une solution de potasse ou de soude jusqu’à une désamérisation seulement partielle, puis séjourne au moins 36 heures dans l’eau avant la saumure au sel marin. Tout tient à cet arrêt précoce : le cahier des charges attribue à cette méthode le craquant, noté au-dessus de 3 sur l’échelle du Conseil oléicole international, et les arômes de beurre et de noisette qu’il dit typiques."},
tip:{en:"Once opened, keep them in their brine in the fridge and serve them cold and whole, as sold: the appellation allows them neither cracked nor slashed. If they go into a dish, add them at the end; long cooking softens exactly what you paid for.",
fr:"Une fois ouvertes, gardez-les dans leur saumure au réfrigérateur et servez-les froides et entières, telles qu’on les vend : l’appellation ne les admet ni cassées ni tailladées. Si elles entrent dans un plat, ajoutez-les à la fin ; une longue cuisson ramollit justement ce qui fait leur prix."},
pairs:["anchovy","garlic","lemon","almond","thyme","morue-salee","olive-oil","fennel"],
svg:'<path class="f1 sf" d="M48 22q10 7 10 25t-10 25q-10-7-10-25t10-25Z"/><path class="s" d="M48 22v-7"/><ellipse class="f3 sf" cx="28" cy="52" rx="4" ry="2.5"/><circle class="dot" cx="68" cy="46" r="2.2"/><circle class="dot" cx="66" cy="58" r="2.2"/>'},
{id:"olive-noire-baux",cat:"condiments",parent:"olive",sign:"AOP",price:2,pk:"32–34 €/kg",name:{en:"Black olives of the Vallée des Baux-de-Provence",fr:"Olives noires de la vallée des Baux-de-Provence"},latin:"Olea europaea 'Grossane'",
origin:{en:"Alpilles, Bouches-du-Rhône",fr:"Alpilles, Bouches-du-Rhône"},season:[],
flavor:["earthy","fruity","salty","bitter"],texture:["tender","moist"],
story:{en:"Only the Grossane qualifies, a large, short olive with a flat base, picked once at least 70% of a lot is black or turning and delivered to the confiseur within 48 hours. Two cures are allowed: pricked and dusted with sea salt, then kept between 2 and 4 °C for at most 12 months, or brine. They are sold whole, neither cracked, slashed nor flavoured; the specification says the plain cure is what keeps the fruit's own character, its truffle, cep, sourdough and red-wine notes.",
fr:"Seule la grossane y a droit, une olive grosse et courte à base tronquée, cueillie quand au moins 70 % du lot est noir ou tournant, et livrée au confiseur dans les 48 heures. Deux préparations sont admises : piquée et saupoudrée de sel de mer, puis conservée entre 2 et 4 °C pendant 12 mois au plus, ou en saumure. Elles sont vendues entières, ni cassées, ni tailladées, ni aromatisées ; selon le cahier des charges, c’est cette préparation simple qui conserve le caractère propre du fruit, ses notes de truffe, de cèpe, de pain au levain et de vin rouge."},
tip:{en:"The salt-pricked olives are a chilled product: keep them in the fridge. Producers sell them fresh in winter, still pinkish to orange-brown and fresh-tasting; over the following months they darken and take on nut and red-wine notes. Serve them whole with bread, or stone them into a lamb daube at the end.",
fr:"Les olives piquées au sel se gardent au froid : rangez-les au réfrigérateur. Les producteurs les vendent fraîches en hiver, encore rosées à brun orangé et au goût frais ; au fil des mois, elles foncent et prennent des notes de noix et de vin rouge. Servez-les entières avec du pain, ou dénoyautez-les dans une daube d’agneau en fin de cuisson."},
pairs:["lamb","thyme","rosemary","garlic","orange","olive-oil","anchovy","banon"],
svg:'<path class="f3 sf" d="M46 28q21 0 21 21t-21 23q-19-4-19-23t19-21Z"/><path class="s" d="M34 42q8 6 6 17M45 32q6 11 2 23M56 33q6 10 2 22"/><circle class="dot" cx="62" cy="66" r="1.6"/><circle class="dot" cx="29" cy="64" r="1.6"/><circle class="dot" cx="52" cy="24" r="1.6"/>'}
]);
