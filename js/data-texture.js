...
flavor:["mild","earthy"],texture:["airy","powdery","dry"],
...
flavor:["pungent","salty","bitter"],texture:["granular","hard","dry"],
...
flavor:["mild","sour","fresh"],texture:["granular","dry"],
...
flavor:["salty","mild","bitter"],texture:["powdery","smooth","dry"],
...
flavor:["bitter","salty"],texture:["granular","hard","dry"],
...
flavor:["mild","sweet","creamy"],texture:["powdery","smooth","dry"],
...
flavor:["sour","tangy","citrus"],texture:["granular","hard","dry"],
...
flavor:["sour","tangy","mild"],texture:["granular","powdery","dry"],
...
fr:"0,5 % du poids de farine, pas davantage. Les enzymes ne s’arrêtent pas : la main lourde donne une pâte molle, une mie gommeuse et une croûte qui fonce et colle bien avant que le pain soit cuit à cœur. Écartez-le des pâtes longuement fermentées, qui ont déjà produit leur sucre."},
...
flavor:["mild","delicate"],texture:["flaky","soft","smooth"],
...
flavor:["mild","fresh","delicate"],texture:["flaky","soft","smooth"],
...
flavor:["mild","creamy"],texture:["airy","powdery","dry"],
...
flavor:["bitter","pungent"],texture:["fluid","smooth"],
...
flavor:["earthy","nutty","mild"],texture:["airy","powdery","dry"],
...
pairs:["rice","kome-koji","shio-koji","soy-bean","barley","miso","junmai-sake","salt"],
...
flavor:["mild","delicate"],texture:["brittle","smooth","dry"],
...
flavor:["bitter","briny","marine"],texture:["granular","hard","dry"],
...
flavor:["mild","fresh"],texture:["fluid","smooth"],
...
flavor:["mild","milky","creamy"],texture:["fluid","smooth"],
...
flavor:["salty","bitter","mild"],texture:["granular","powdery","dry"],
...
flavor:["nutty","earthy","mild"],texture:["granular","dry"],
...
flavor:["sour","tangy","fruity"],texture:["granular","hard","dry"],
...
flavor:["mild","delicate","sweet","milky"],texture:["powdery","smooth","dry"],
...
flavor:["mild","delicate"],texture:["powdery","smooth","dry"],
...
flavor:["mild","delicate","milky","earthy"],texture:["granular","powdery","dry"],
...
fr:"Pesez-le à 0,1 à 0,5 % du plat et goûtez entre chaque ajout — au-delà, un bouillon devient plat et vaguement sucré plutôt que plus profond. Il apporte environ trois fois moins de sodium que le sel de table à poids égal : de quoi rendre du goût à un plat qu’on a dû sous-saler."},
pairs:["kombu","katsuobushi","tomato","parmesan","anchovy","soy-sauce","mushroom","chicken","miso","fish-sauce"],
...
fr:"Inutile seul : ne le dosez jamais isolément. Comptez environ une part pour dix d’une source de glutamate — une pincée dans un bouillon qui porte déjà du kombu, de la tomate ou du parmesan, pas dans de l’eau claire."},
pairs:["katsuobushi","niboshi","kombu","glutamate-monosodique","tomato","parmesan","pork","beef","chicken"],
...
fr:"Même règle que l’inosinate : avec une source de glutamate, jamais à sa place. L’eau de trempage des shiitakés séchés en porte déjà : un bouillon bâti dessus n’en réclame aucun."},
pairs:["dried-shiitake-donko","shiitake","kombu","glutamate-monosodique","mushroom","soy-sauce","chicken"],
svg:'<path class="f1 sf" d="M20 42q10-18 28-18t28 18q-13 9-28 9t-28-9z"/><path class="s" d="M28 40q8-11 20-11t20 11" stroke-width="1.5"/><path class="s" d="M34 33l4 8M48 28v12M62 33l-4 8" stroke-width="1.5"/><path class="f2 sf" d="M40 51h16v14q0 5-8 5t-8-5z"/><path class="f1 sf" d="M28 76l6-7 6 7-6 7z"/><path class="f1 sf" d="M58 76l6-7 6 7-6 7z"/>'}
]);
