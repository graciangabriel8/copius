...
{id:"farine-de-chataigne-corse",cat:"grains",parent:"chestnut-flour",sign:"AOP",price:2,pk:"20–27 €/kg",name:{en:"Corsican chestnut flour",fr:"Farine de châtaigne corse – Farina castagnina corsa"},latin:"Castanea sativa (Corsican local varieties)",
origin:{en:"Corsica, 400 to 1,200 m",fr:"Corse, de 400 à 1 200 m"},season:[],
flavor:["sweet","nutty","toasty","milky"],texture:["powdery","smooth"],
story:{en:"The nuts, from local Corsican varieties only, are gathered once fallen between 1 October and 31 December, then dried for at least eighteen days over a fire of chestnut, alder, strawberry-tree, heather, ash, beech or oak, fed with the nuts' own shells and inner skins — or six days in a forced-air dryer. Crushing is banned; granite, flint or schist millstones grind them until at least 70% passes a 106-micron sieve.",
fr:"Issues des seules variétés locales corses, les châtaignes sont ramassées après leur chute naturelle, entre le 1er octobre et le 31 décembre, puis séchées au moins dix-huit jours sur un feu de châtaignier, d’aulne, d’arbousier, de bruyère, de frêne, de hêtre ou de chêne, nourri de leurs propres peaux — ou six jours en séchoir à air pulsé. Le concassage est interdit : des meules de granite, de silex ou de schiste les moulent jusqu’à ce qu’au moins 70 % de la farine passe au tamis de 106 microns."},
tip:{en:"Read the label: passé au four (infurnata or affurnata) means the dried nuts were baked in a wood-fired oven before milling, for a deeper biscuit flavour. Sift it twice before use, and keep the bag tightly closed — it takes up damp and clumps.",
fr:"Lisez l’étiquette : « passé au four » (infurnata, affurnata) signale des châtaignes sèches cuites au four à bois avant la mouture, au goût de biscuit plus marqué. Tamisez-la deux fois, et gardez le sachet bien fermé : elle prend l’humidité et s’agglomère."},
pairs:["brocciu","figatellu","lonzu","cervione-hazelnut","myrtle","honey","egg","olive-oil"],
svg:'<path class="f2 sf" d="M17 71q1-13 9-21 5-6 9-10 3-3 6 1 3 5 7 9 10 8 11 21z"/><path class="f1 sf" d="M50 75q-3-11 5-19 5-6 9-9 4 1 6 5 5 9 3 17-1 6-5 7-10 2-16 1-2-1-2-2z"/><path class="s" d="M64 47q1-6 4-8" stroke-width="2"/><path class="f2 sf" d="M51 73q9 4 17-1-3 6-9 6-6 1-8-5z"/><path class="s" d="M30 29v3M41 22v3M52 26v3M62 35v3" stroke-width="2"/>'}
]);
