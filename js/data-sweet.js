...
{id:"miel-de-corse",cat:"sweet",parent:"honey",sign:"AOP",price:2,pk:"30–38 €/kg",name:{en:"Corsica honey (Mele di Corsica)",fr:"Miel de Corse – Mele di Corsica"},latin:"Apis mellifera mellifera (Corsican ecotype), maquis nectar and honeydew",
origin:{en:"Corsica",fr:"Corse"},season:[],
flavor:["floral","fruity","woody","bitter"],texture:["viscous","smooth"],
story:{en:"One appellation, six honeys, named for the season and the plant cover the bees worked: spring, spring maquis, maquis honeydew, chestnut grove, summer maquis and autumn maquis, each checked by pollen analysis against a Corsican reference base. The bees must be of the Corsican ecotype, and honeys from cultivated crops are excluded, citrus apart. Tree heather leads in spring, chestnut in early summer and strawberry tree in autumn–winter, which is why the late jars turn bitter, like coffee grounds.",
fr:"Une appellation, six miels, nommés d’après la saison et la végétation butinée : printemps, maquis de printemps, miellats du maquis, châtaigneraie, maquis d’été et maquis d’automne, chacun vérifié par analyse pollinique face à un référentiel corse. Les abeilles doivent être d’écotype corse, et les miels de plantes cultivées sont exclus, agrumes mis à part. La bruyère blanche domine au printemps, le châtaignier au début de l’été, l’arbousier en automne-hiver : d’où l’amertume de marc de café des derniers pots."},
tip:{en:"Read the variety on the jar before you cook with it: the pale, sweet summer maquis suits brocciu and fruit, while chestnut grove and autumn maquis are bitter enough to stand up to cheese, roast figs or a dressing. Keep it closed and away from heat.",
fr:"Lisez la variété sur le pot avant de cuisiner : le maquis d’été, clair et sucré, va au brocciu et aux fruits ; la châtaigneraie et le maquis d’automne, assez amers, tiennent tête au fromage, aux figues rôties ou à une vinaigrette. Gardez-le fermé et loin de la chaleur."},
pairs:["brocciu","chestnut-flour","fig","clementine","almond","lemon","goat-cheese","yogurt"],
svg:'<path class="s" d="M60 36L44 52"/><path class="f2 sf" d="M34 58h20M32 63h24M34 68h20M38 73h12" stroke-width="4"/><path class="f2 sf" d="M40 50a8 8 0 0016 0 8 8 0 00-16 0z" transform="translate(-6 8)"/>'},
{id:"miel-de-sapin-des-vosges",cat:"sweet",parent:"fir-honeydew-honey",sign:"AOP",price:2,pk:"28–32 €/kg",name:{en:"Vosges fir honey",fr:"Miel de sapin des Vosges"},latin:"Honeydew of Abies alba (A. pectinata)",
origin:{en:"Vosges massif",fr:"Massif des Vosges"},season:[],
flavor:["resinous","toasty","woody","honeyed"],texture:["viscous","smooth"],
story:{en:"It is a honeydew honey, not a flower honey: aphids feed on the sap of the Vosges silver fir and excrete the surplus sugar as honeydew, which the bees gather. The appellation demands electrical conductivity above 950 µS/cm, water at 18% or less, cold extraction and no pasteurisation; it is sold liquid, dark brown with green glints, balsamic and malty without bitterness. The flow follows cycles in the aphid population, so it does not come every year.",
fr:"C’est un miel de miellat, pas de fleurs : des pucerons se nourrissent de la sève du sapin des Vosges et rejettent l’excès de sucre en miellat, que butinent les abeilles. L’appellation exige une conductivité électrique supérieure à 950 µS/cm, au plus 18 % d’eau, une extraction à froid et aucune pasteurisation ; il est vendu liquide, brun foncé à reflets verdâtres, balsamique et malté, sans amertume. La miellée suit les cycles des populations de pucerons : elle ne vient pas tous les ans."},
tip:{en:"It stays liquid, so it pours straight onto fromage blanc or into a dressing for bitter leaves. Store it in the dark, as the specification requires of producers, and if it ever sets, loosen it in a warm water bath rather than a hot pan.",
fr:"Il reste liquide et se verse tel quel sur un fromage blanc ou dans une vinaigrette pour salades amères. Conservez-le à l’abri de la lumière, comme le cahier des charges l’impose aux producteurs, et s’il venait à figer, détendez-le au bain-marie tiède plutôt qu’à la casserole."},
pairs:["fromage-blanc","munster","walnut","mirabelle","quetsche","pear","yogurt","butter"],
svg:'<path class="f3 sf" d="M32 40h28v26q0 6-6 6H38q-6 0-6-6z"/><path class="s" d="M30 34h32v6H30z"/><path class="s" d="M74 24v40"/><path class="f1 sf" d="M74 28l-8 8h16zM74 40l-10 8h20zM74 52l-8 8h16z"/>'}
]);
