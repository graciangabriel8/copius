...
{id:"beurre-d-isigny",cat:"fats",parent:"butter",sign:"AOP",price:2,pk:"16–20 €/kg",name:{en:"Isigny butter",fr:"Beurre d’Isigny"},latin:"Bos taurus (ripened cream)",
origin:{en:"Baie des Veys, Cotentin and Bessin",fr:"Baie des Veys, Cotentin et Bessin"},season:[],
flavor:["creamy","nutty","fresh"],texture:["soft","smooth","creamy"],
story:{en:"The appellation covers 175 low-lying communes around the Baie des Veys; the herd must graze at least seven months a year, and each collection must come from a herd at least 30% Normande. The cream is ripened with lactic cultures for at least 12 hours at 9–15 °C before churning, and acidifying the butter any other way is banned: the hazelnut and fresh-cream notes come from that ripening, not from added flavour. Grass carotenoids turn it buttercup yellow in the grazing season, ivory in winter.",
fr:"L’appellation couvre 175 communes basses autour de la baie des Veys ; le troupeau doit pâturer au moins sept mois par an, et chaque collecte doit provenir d’un troupeau comptant au moins 30 % de vaches normandes. La crème est maturée aux ferments lactiques au moins 12 heures entre 9 et 15 °C avant le barattage, et toute autre façon d’acidifier le beurre est interdite : ses notes de noisette et de crème fraîche viennent de cette maturation, pas d’un arôme ajouté. Les caroténoïdes de l’herbe le teintent de jaune bouton d’or à la saison du pâturage, d’ivoire l’hiver."},
tip:{en:"The shop block is for the table and for finishing sauces; for croissants or puff pastry look for the 'tourage' version, which the specification allows to be crystallised so it rolls out without melting. Keep it tightly wrapped: butter takes up fridge smells.",
fr:"La plaquette du commerce est faite pour la table et pour monter les sauces ; pour les croissants ou la pâte feuilletée, cherchez la version « tourage », que le cahier des charges autorise à cristalliser pour qu’elle s’abaisse au rouleau sans fondre. Gardez-le bien emballé : le beurre prend les odeurs du réfrigérateur."},
pairs:["radish","potato","dover-sole","scallop","shallot","white-wine-vinegar","leek","apple"],
...
{id:"beurre-charentes-poitou",cat:"fats",parent:"butter",sign:"AOP",price:2,pk:"12–28 €/kg",name:{en:"Charentes-Poitou butter",fr:"Beurre Charentes-Poitou"},latin:"Bos taurus (ripened cream)",
origin:{en:"Charente, Charente-Maritime, Deux-Sèvres, Vendée and Vienne",fr:"Charente, Charente-Maritime, Deux-Sèvres, Vendée et Vienne"},season:[],
flavor:["nutty","creamy","milky","fruity"],texture:["firm","smooth"],
story:{en:"The appellation is built on maize: it must make up at least half of the cows' daily base ration, and never less than 1.5 kg of dry matter even at pasture. The specification credits that diet with the saturated fats that keep the butter firm yet malleable, which is why pastry cooks laminate with it. The cream is ripened for at least 16 hours at 7–21 °C, long enough to build lactones, which the specification ties to fruity notes, and the wider range of compounds behind its hazelnut and fresh-cream taste.",
fr:"L’appellation repose sur le maïs : il doit constituer au moins la moitié de la ration de base quotidienne des vaches, et jamais moins de 1,5 kg de matière sèche par jour, même au pâturage. Le cahier des charges attribue à ce régime les acides gras saturés qui rendent le beurre à la fois ferme et malléable — d’où sa place dans le feuilletage. La crème mature au moins 16 heures entre 7 et 21 °C, assez longtemps pour former des lactones, associées à des notes fruitées, et les composés qui lui donnent son goût de noisette et de crème fraîche."},
tip:{en:"Use it where the butter has to hold: puff pastry, sablés, a galette dough. Let it lose its fridge chill for a few minutes before laminating - it is firm, not brittle. It is also sold as 'Beurre des Charentes' or 'Beurre des Deux-Sèvres': the same appellation.",
fr:"Employez-le là où le beurre doit tenir : pâte feuilletée, sablés, pâte à galette. Laissez-le perdre quelques minutes le froid du réfrigérateur avant le tourage : il est ferme sans être cassant. Il se vend aussi sous les noms « Beurre des Charentes » et « Beurre des Deux-Sèvres » : c’est la même appellation."},
pairs:["flour-t45","sugar","egg","vanilla","apple","cassonade","mussel","oyster"],
svg:'<path class="f1 sf" d="M30 50h28v16H30z"/><path class="f1 sf" d="M30 50l8-8h28l-8 8z"/><path class="f1 sf" d="M58 50l8-8v16l-8 8z"/><path class="s" d="M62 60l6 6"/>'},
{id:"beurre-de-bresse",cat:"fats",parent:"beurre-de-baratte",sign:"AOP",price:2,pk:"14–16 €/kg",name:{en:"Bresse butter",fr:"Beurre de Bresse"},latin:"Bos taurus (Montbéliarde herd, ripened cream)",
origin:{en:"Bresse: Ain, Jura and Saône-et-Loire",fr:"Bresse : Ain, Jura et Saône-et-Loire"},season:[],
flavor:["milky","nutty","floral"],texture:["soft","airy"],
story:{en:"Every Bresse butter is unsalted and churned in batches: continuous churning is banned, churns are conical or biconical and hold at most 5,000 litres, and the butter may not be pumped between churn and pack. The cream, from herds at least half Montbéliarde, is ripened 18 to 24 hours at 12–18 °C. The fine water droplets and micropores of traditional churning give it a supple, airy, slightly grainy texture, and the specification credits it with a foam that holds all the way to the plate.",
fr:"Le beurre de Bresse est toujours doux et baratté par lots : le barattage en continu est interdit, les barattes sont coniques ou biconiques et ne dépassent pas 5 000 litres, et le beurre ne peut être pompé entre la baratte et le conditionnement. La crème, issue de troupeaux au moins pour moitié montbéliards, mature de 18 à 24 heures entre 12 et 18 °C. Les fines gouttelettes d’eau et les microporosités de la baratte traditionnelle lui donnent une texture souple, aérée, légèrement granuleuse, et le cahier des charges lui prête une mousse qui tient jusque dans l’assiette."},
tip:{en:"Cook with it rather than hiding it in pastry: let it foam in the pan for frogs' legs, a trout meunière or the juices of a Bresse chicken, and baste. It is only sold unsalted, so salt in the pan or at the table.",
fr:"Cuisinez-le plutôt que de le cacher dans une pâte : laissez-le mousser à la poêle pour des cuisses de grenouilles, une truite meunière ou le jus d’un poulet de Bresse, et arrosez. Il n’existe qu’en doux : salez à la poêle ou à table."},
pairs:["bresse-chicken","trout","garlic","parsley","morel","potato","cream","sugar"],
...
{id:"huile-olive-nyons",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"22–35 €/L",name:{en:"Nyons olive oil",fr:"Huile d’olive de Nyons"},latin:"Olea europaea 'Tanche'",
origin:{en:"Nyonsais and Baronnies, Drôme and Vaucluse",fr:"Nyonsais et Baronnies, Drôme et Vaucluse"},season:[],
flavor:["buttery","nutty","fruity","mild"],texture:["viscous","silky"],
story:{en:"One olive only: the Tanche, from 53 communes of the Drôme and Vaucluse on the 44th parallel, the northern limit of the olive tree, with pollinator fruit capped at 5%. Each lot must be at least 65% coloured rather than green, and that ripeness is what makes the oil buttery and thick, with bitterness and pungency held at 2 out of 10 or less. It was the first French olive oil to win an AOC, by decree in January 1994.",
fr:"Une seule olive : la tanche, cultivée dans 53 communes de la Drôme et du Vaucluse, sur le 44e parallèle, à la limite nord de l’olivier ; les fruits des pollinisateurs ne dépassent pas 5 %. Chaque lot doit compter au moins 65 % d’olives qui ne sont plus vertes, et c’est cette maturité qui rend l’huile beurrée et grasse, avec une amertume et une ardence plafonnées à 2 sur 10. Ce fut la première huile d’olive française reconnue en AOC, par décret de janvier 1994."},
tip:{en:"With so little bitterness it is the oil to whisk into a mayonnaise or an aïoli, and to pour over what a peppery oil would drown: white fish, boiled potatoes, a young Picodon. The specification requires it to be stored with as little contact with air as possible; do the same at home by decanting a large can into small bottles kept full and closed.",
fr:"Si peu amère, c’est l’huile à monter en mayonnaise ou en aïoli, et à verser sur ce qu’une huile poivrée écraserait : poisson blanc, pommes de terre à l’eau, picodon jeune. Le cahier des charges impose de la stocker en limitant son contact avec l’air ; faites de même chez vous en transvasant un grand bidon dans de petites bouteilles pleines et bien fermées."},
pairs:["picodon","olive-nyons","potato","garlic","egg","thyme","sea-bass","tomato"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-vallee-des-baux",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"26–40 €/L",name:{en:"Vallée des Baux-de-Provence olive oil",fr:"Huile d’olive de la vallée des Baux-de-Provence"},latin:"Olea europaea (Salonenque, Aglandau, Grossane, Verdale)",
origin:{en:"Alpilles, Bouches-du-Rhône",fr:"Alpilles, Bouches-du-Rhône"},season:[],
flavor:["grassy","fruity","nutty","earthy"],texture:["fluid","silky"],
story:{en:"No single-variety oil may carry the name: each is a blend of at least two of Salonenque, Aglandau, Grossane and Verdale des Bouches-du-Rhône, grown around the Alpilles. Milled less than three days after picking, it tastes of cut grass, apple and raw artichoke; labelled 'olives maturées', the olives were first left to ferment for three to ten days, which leaves bitterness at 1 out of 10 or less and brings black olive, cocoa and mushroom.",
fr:"Aucune huile monovariétale n’a droit au nom : chacune assemble au moins deux variétés parmi la salonenque, l’aglandau, la grossane et la verdale des Bouches-du-Rhône, cultivées autour des Alpilles. Triturée moins de trois jours après la récolte, elle sent l’herbe coupée, la pomme et l’artichaut cru ; avec la mention « olives maturées », les olives ont d’abord fermenté trois à dix jours, ce qui ramène l’amertume à 1 sur 10 au plus et apporte l’olive noire, le cacao et le champignon."},
tip:{en:"Do what the valley did with the first oil of the season, which the specification says was eaten on hot lentils: pour the fresh oil over them raw. Keep the 'olives maturées' oil for what wants softness without pepper: salt cod, boiled potatoes, a tapenade.",
fr:"Faites comme la vallée avec la première huile de la saison, que le cahier des charges dit servie sur des lentilles chaudes : versez-la crue dessus. Gardez l’huile « olives maturées » pour ce qui demande de la douceur sans poivre : morue, pommes de terre à l’eau, tapenade."},
pairs:["lentils","olive-cassee-baux","morue-salee","potato","tomato","garlic","poivrade-artichoke","goat-cheese"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-aix-en-provence",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"23–44 €/L",name:{en:"Aix-en-Provence olive oil",fr:"Huile d’olive d’Aix-en-Provence"},latin:"Olea europaea (Aglandau, Cayanne, Salonenque)",
origin:{en:"Pays d'Aix, Bouches-du-Rhône and Var",fr:"Pays d’Aix, Bouches-du-Rhône et Var"},season:[],
flavor:["grassy","peppery","bitter","nutty"],texture:["silky","viscous"],
story:{en:"Aglandau, Cayanne and Salonenque must make up at least 80% of the trees, and the specification credits the last two with softening Aglandau's aggressive edge early in the season. Each lot holds at least 40% turning olives, green going yellow, and the new oil shows it: bitterness and pungency run from 1 to 5 out of 10 for four months, then settle between 1 and 3. Olives held four to ten days before milling give the soft 'olives maturées' version instead.",
fr:"L’aglandau, la cayanne et la salonenque doivent représenter au moins 80 % des arbres, et le cahier des charges prête aux deux dernières le pouvoir d’ôter, en début de saison, le côté agressif de l’aglandau. Chaque lot compte au moins 40 % d’olives tournantes, passant du vert franc au jaune, et l’huile nouvelle le montre : amertume et ardence de 1 à 5 sur 10 pendant quatre mois, puis entre 1 et 3. Des olives gardées quatre à dix jours avant trituration donnent au contraire la version douce, « olives maturées »."},
tip:{en:"Buy it new, in its first four months, if you want the pepper, and use it raw: over a bean soup at the table, on a tomato, on grilled bread rubbed with garlic. After that it calms down; keep it cool and dark, as the specification requires of producers.",
fr:"Achetez-la nouvelle, dans ses quatre premiers mois, si vous voulez le poivré, et servez-la crue : sur une soupe de haricots au moment de servir, sur une tomate, sur du pain grillé frotté d’ail. Ensuite elle s’assagit ; gardez-la au frais et à l’abri de la lumière, comme le cahier des charges l’impose aux producteurs."},
pairs:["tomato","white-beans","garlic","poivrade-artichoke","brousse-du-rove","fennel","basil","sea-bream"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-haute-provence",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"27–36 €/L",name:{en:"Haute-Provence olive oil",fr:"Huile d’olive de Haute-Provence"},latin:"Olea europaea 'Aglandau'",
origin:{en:"Durance valley, Alpes-de-Haute-Provence",fr:"Vallée de la Durance, Alpes-de-Haute-Provence"},season:[],
flavor:["peppery","grassy","fruity","bitter"],texture:["fluid","smooth"],
story:{en:"Aglandau makes up 80 to 100% of the trees and of the oil, picked fairly green in November within a harvest the specification closes 55 days after it opens, ahead of the hard frosts of late December. No lot may hold more than 30% black olives; the green fruit's chlorophyll gives the young oil green glints that fade to gold in the light, and polyphenols give it a pungency of at least 2 out of 10 and help it keep.",
fr:"L’aglandau fait de 80 à 100 % des arbres et de l’huile ; on la cueille encore assez verte, en novembre, dans une récolte que le cahier des charges clôt 55 jours après son ouverture, avant les fortes gelées de fin décembre. Aucun lot ne peut contenir plus de 30 % d’olives noires : la chlorophylle des fruits verts donne à l’huile jeune des reflets verts qui virent au doré à la lumière, et les polyphénols lui donnent une ardence d’au moins 2 sur 10 et l’aident à se garder."},
tip:{en:"Use it where the pepper has something to push against: raw poivrade artichokes, grilled Sisteron lamb, a bowl of chickpeas. A bottle that has lost its green tint has not gone off, since the specification says the colour fades without changing the taste, but keep it in the dark all the same.",
fr:"Servez-la là où son poivré trouve à qui parler : artichauts poivrade crus, agneau de Sisteron grillé, pois chiches. Une bouteille qui a perdu ses reflets verts n’est pas gâtée, puisque le cahier des charges précise que la couleur s’en va sans altérer le goût, mais gardez-la tout de même à l’abri de la lumière."},
pairs:["poivrade-artichoke","agneau-de-sisteron","chickpeas","banon","tomato","garlic","almond","thyme"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-provence",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"25–40 €/L",name:{en:"Provence olive oil",fr:"Huile d’olive de Provence"},latin:"Olea europaea (Aglandau, Bouteillan, Cayon, Salonenque)",
origin:{en:"Provence, from the Rhône to the Estérel",fr:"Provence, du Rhône à l’Estérel"},season:[],
flavor:["grassy","bitter","peppery","toasty"],texture:["fluid","smooth"],
story:{en:"A blend by rule: at least two varieties, Aglandau at 20% or more, with Bouteillan, Cayon and Salonenque, grown from the Rhône to the Estérel. Olives are picked from the turning stage and either milled within four days, bitter and pungent at 1.5 to 3.5 out of 10 with grass and raw artichoke, or first held four to ten days, as mills that could not keep up once did, giving an 'olives maturées' oil of black olive and toasted bread with almost no bite.",
fr:"Un assemblage par règle : au moins deux variétés, dont 20 % d’aglandau au minimum, avec la bouteillan, le cayon et la salonenque, cultivées du Rhône à l’Estérel. Les olives sont cueillies dès le stade tournant, puis soit triturées en moins de quatre jours, avec une amertume et une ardence de 1,5 à 3,5 sur 10, l’herbe fraîche et l’artichaut cru, soit gardées d’abord quatre à dix jours, comme le faisaient autrefois les moulins débordés, pour une huile « olives maturées » d’olive noire et de pain grillé, presque sans amertume ni piquant."},
tip:{en:"The two styles do different jobs: the green one raw, on grilled vegetables or a bowl of chickpeas; the 'olives maturées' one wherever bitterness would be unwelcome, as in an aïoli with salt cod, potatoes and green beans.",
fr:"Les deux styles n’ont pas le même rôle : la verte crue, sur des légumes grillés ou des pois chiches ; l’« olives maturées » partout où l’amertume dérange, comme dans un aïoli avec morue, pommes de terre et haricots verts."},
pairs:["garlic","morue-salee","potato","green-bean","chickpeas","egg","tomato","eggplant"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-nice",cat:"fats",parent:"olive-oil",sign:"AOP",price:3,pk:"40–48 €/L",name:{en:"Nice olive oil",fr:"Huile d’olive de Nice"},latin:"Olea europaea 'Cailletier'",
origin:{en:"Alpes-Maritimes, around Nice",fr:"Alpes-Maritimes, pays niçois"},season:[],
flavor:["nutty","mild","fruity","delicate"],texture:["smooth","silky"],
story:{en:"The specification caps it low on the International Olive Council's tasting scale, pungency at 2 and bitterness at 1.5 out of 10, with almond as the leading aroma. The softness comes from the Cailletier, at least 95% of the trees in each orchard, and from late picking: the harvest runs from November to April, and the specification notes that the later the olives come in, the sweeter the oil. The paste may not be warmed above 27 °C.",
fr:"Le cahier des charges la place bas sur l’échelle de dégustation du Conseil oléicole international : ardence d’au plus 2 et amertume d’au plus 1,5 sur 10, avec l’amande pour arôme principal. Cette douceur tient au cailletier, au moins 95 % des oliviers de chaque verger, et à la récolte tardive : on cueille de novembre à avril, et le cahier des charges note que l’huile est d’autant plus douce que les olives sont récoltées tard. La pâte ne doit pas être chauffée au-delà de 27 °C."},
tip:{en:"Keep it for raw use, where its low pungency lets everything else speak: the specification itself cites the pan bagnat, a round roll soaked in olive oil and filled with tomato and salt. Store it as producers must, away from light, air and heat.",
fr:"Réservez-la au cru, là où sa faible ardence laisse parler le reste : le cahier des charges cite lui-même le pan bagnat, petit pain rond humecté d’huile d’olive et garni de tomate et de sel. Conservez-la comme les producteurs y sont tenus, à l’abri de la lumière, de l’air et de la chaleur."},
pairs:["tomato","basil","anchovy","tuna","swiss-chard","chickpea-flour","sea-bass","lemon"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-nimes",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"31–38 €/L",name:{en:"Nîmes olive oil",fr:"Huile d’olive de Nîmes"},latin:"Olea europaea 'Picholine'",
origin:{en:"Gard and eastern Hérault",fr:"Gard et est de l’Hérault"},season:[],
flavor:["grassy","bitter","peppery","fruity"],texture:["smooth","silky"],
story:{en:"At least 70% of the olives milled must be Picholine, a late-ripening variety, which is why the orchards generally stay below 350 m, out of the frost. The fruit is picked just ripe, once at least a tenth has turned from green to yellow, and the oil is green and assertive: bitterness and pungency each score 1.5 to 4.5 out of 10, over fresh grass, cut hay, raw artichoke, tomato plant and pineapple. Négrette or Noirette may be blended in to soften it with almond.",
fr:"Au moins 70 % des olives mises en œuvre doivent être des picholines, variété à maturité tardive : c’est pourquoi les vergers restent en général sous 350 m, à l’abri du gel. Les olives sont cueillies juste mûres, dès qu’au moins un dixième est passé du vert au jaune, et l’huile est verte et affirmée : amertume et ardence notées chacune de 1,5 à 4,5 sur 10, sur l’herbe fraîche, le foin coupé, l’artichaut cru, le plant de tomate et l’ananas. La négrette ou la noirette peuvent l’adoucir d’une note d’amande."},
tip:{en:"Pour it raw over things sturdy enough for its bitterness and pepper, tomatoes, grilled peppers, white beans or salt cod, and keep a milder oil for delicate fish.",
fr:"Versez-la crue sur ce qui tient tête à son amertume et à son ardence : tomates, poivrons grillés, haricots blancs ou morue, et gardez une huile plus douce pour les poissons fins."},
pairs:["tomato","morue-salee","artichoke","bell-pepper","garlic","white-beans","lamb","rosemary"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-languedoc",cat:"fats",parent:"olive-oil",sign:"AOP",price:2,pk:"28–36 €/L",name:{en:"Languedoc olive oil",fr:"Huile d’olive du Languedoc"},latin:"Olea europaea ('Lucques', 'Olivière' and local varieties)",
origin:{en:"Aude and Hérault",fr:"Aude et Hérault"},season:[],
flavor:["fruity","nutty","fresh","mild"],texture:["smooth","silky"],
story:{en:"The appellation rules out a single-variety oil: every lot blends at least two varieties, led by the Lucques or the Olivière, and neither may exceed 70% of the oil. The olives are picked when 40 to 70% have turned from green to yellow, fruit the specification calls moderately ripe, and milled within eight days, which is where its dominant tomato and almond come from; bitterness stays at 3 out of 10 or below. It became a European AOP in 2023.",
fr:"L’appellation exclut l’huile monovariétale : chaque lot assemble au moins deux variétés, menées par la lucques ou l’olivière, et aucune des deux ne peut dépasser 70 % de l’huile. Les olives sont cueillies quand 40 à 70 % d’entre elles sont passées du vert au jaune, des fruits que le cahier des charges dit moyennement mûrs, et triturées dans les huit jours : de là ses notes dominantes de tomate et d’amande. L’amertume ne dépasse pas 3 sur 10. AOP européenne depuis 2023."},
tip:{en:"A medium-intensity oil for everyday raw use: dress tomatoes, grilled courgettes or sardines with it, and reach for it wherever a more bitter oil would take over.",
fr:"Une huile d’intensité moyenne pour le cru de tous les jours : assaisonnez-en tomates, courgettes grillées ou sardines, et prenez-la partout où une huile plus amère prendrait le dessus."},
pairs:["tomato","almond","sardine","olive-lucques","pelardon","zucchini","eggplant","garlic"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-olive-corse",cat:"fats",parent:"olive-oil",sign:"AOP",price:3,pk:"24–50 €/L",name:{en:"Corsican olive oil (Oliu di Corsica)",fr:"Huile d’olive de Corse – Oliu di Corsica"},latin:"Olea europaea (Sabine, Ghjermana, Capanace, Zinzala, Aliva Nera, Curtinese)",
origin:{en:"Corsica",fr:"Corse"},season:[],
flavor:["nutty","mild","herbal","fruity"],texture:["smooth","silky"],
story:{en:"The appellation rests on six island varieties, including the Sabine, selected locally from wild olive trees, and the Capanace of Cap Corse, and on late harvests that frost-free slopes allow; the specification credits that long hang time with the maquis notes in the oil. Oil labelled récolte à l'ancienne may only use olives left to drop into nets, more than half of them black: bitterness and pungency fall from at most 3 to at most 1 out of 10, and the aromas turn to dried fruit and mushroom.",
fr:"L’appellation repose sur six variétés de l’île, dont la sabine, sélectionnée sur place à partir d’oliviers sauvages, et la capanace du Cap Corse, et sur des récoltes tardives que permettent des coteaux sans gel ; le cahier des charges attribue à ce long séjour sur l’arbre les notes de maquis de l’huile. La mention « récolte à l’ancienne » n’admet que des olives tombées d’elles-mêmes dans les filets, noires pour plus de moitié : amertume et ardence passent d’au plus 3 à au plus 1 sur 10, et les arômes tournent aux fruits secs et au champignon."},
tip:{en:"Its low bitterness suits delicate things: fresh brocciu, a baked white fish, a dish of broad beans. Read the label: récolte à l'ancienne is the rounder, fuller style, while the oil without it keeps more almond and artichoke.",
fr:"Sa faible amertume sert les choses délicates : un brocciu frais, un poisson blanc au four, des fèves. Lisez l’étiquette : « récolte à l’ancienne » désigne le style le plus rond et le plus ample, tandis que l’huile sans mention garde davantage d’amande et d’artichaut."},
pairs:["brocciu","chestnut-flour","sea-bream","clementine","myrtle","garlic","figatellu","fava-bean"],
svg:'<path class="f1 sf" d="M44 26h8v10l4 6v30q0 6-8 6t-8-6V42l4-6z"/><path class="s" d="M44 26h8"/><path class="f3 sf" d="M40 66a4 4 0 108 0 4 4 0 10-8 0z" transform="translate(4 0)"/><path class="s" d="M52 62q4-4 8-4"/>'},
{id:"huile-noix-perigord",cat:"fats",parent:"walnut-oil",sign:"AOP",price:3,pk:"40–52 €/L",name:{en:"Périgord walnut oil",fr:"Huile de noix du Périgord"},latin:"Juglans regia ('Franquette', 'Marbot', 'Corne', 'Grandjean')",
origin:{en:"Périgord and bordering areas, six departments",fr:"Périgord et ses marges, sur six départements"},season:[],
flavor:["nutty","toasty","rich","delicate"],texture:["silky","fluid","viscous"],
story:{en:"The specification recognises two oils under one name, split by the temperature of the ground kernel paste. Pressed cold, never above 45 °C, it runs from straw-yellow to gold, stays fluid and tastes of dry walnut and breadcrumb; heated in a pan to between 60 and 100 °C, it turns golden-brown and coating, with notes of toasted crust and biscuit. At least half the kernels must be Franquette, the variety brought to Périgord after the 1956 frost.",
fr:"Le cahier des charges reconnaît deux huiles sous un même nom, que sépare la température de la pâte de cerneaux. Extraite à froid, jamais au-delà de 45 °C, elle va du jaune paille au jaune doré, reste fluide et sent le cerneau sec et la mie de pain ; chauffée à la poêle entre 60 et 100 °C, elle devient brun doré et nappante, avec des notes de croûte de pain et de biscuit. La franquette, introduite en Périgord après le gel de 1956, fournit au moins la moitié des cerneaux."},
tip:{en:"The label tells you which one you have: only the cold oil may say extraite à froid. Use it on bitter leaves, dandelion, frisée or endive, and the heated one on green beans, potatoes or a warm goat cheese; never fry with either, and keep the bottle away from light and heat.",
fr:"L’étiquette vous dit laquelle vous tenez : seule l’huile extraite à froid porte la mention « extraite à froid ». Réservez-la aux salades amères, pissenlit, frisée ou endive, et l’huile chauffée aux haricots verts, aux pommes de terre ou au chèvre chaud ; ne faites jamais frire ni l’une ni l’autre, et gardez la bouteille à l’abri de la lumière et de la chaleur."},
pairs:["walnut","dandelion","frisee","endive","green-bean","potato","rocamadour","magret"],
svg:'<path class="f1 sf" d="M40 76V44h16v32z"/><path class="s" d="M40 52h16"/><circle class="f2 sf" cx="48" cy="34" r="7"/><path class="s" d="M48 28v12"/>'}
]);
