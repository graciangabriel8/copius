...
{id:"antep-pistachio",cat:"nuts",parent:"pistachio",price:3,pk:"40–80 €/kg",name:{en:"Antep pistachio",fr:"Pistache d'Antep"},latin:"Pistacia vera",
...
{id:"avola-almond",cat:"nuts",parent:"almond",price:2,pk:"28–50 €/kg",name:{en:"Avola almond",fr:"Amande d'Avola"},latin:"Prunus dulcis (Pizzuta d'Avola)",
...
{id:"black-sesame",cat:"nuts",parent:"sesame",price:2,pk:"9–16 €/kg",name:{en:"Black sesame",fr:"Sésame noir"},latin:"Sesamum indicum",
...
{id:"bronte-pistachio",cat:"nuts",parent:"pistachio",sign:"DOP",luxe:true,price:4,pk:"90–180 €/kg",name:{en:"Bronte pistachio",fr:"Pistache de Bronte"},latin:"Pistacia vera",
...
{id:"cervione-hazelnut",cat:"nuts",parent:"hazelnut",rare:true,price:3,pk:"25–45 €/kg",name:{en:"Cervione hazelnut",fr:"Noisette de Cervione"},latin:"Corylus avellana (Fertile de Coutard)",
...
{id:"fresh-hazelnut",cat:"nuts",parent:"hazelnut",price:2,pk:"8–15 €/kg",name:{en:"Fresh green hazelnut",fr:"Noisette fraîche"},latin:"Corylus avellana",
...
{id:"fresh-walnut",cat:"nuts",parent:"walnut",price:1,pk:"6–12 €/kg",name:{en:"Fresh walnut",fr:"Noix fraîche"},latin:"Juglans regia",
...
{id:"grenoble-walnut",cat:"nuts",parent:"walnut",sign:"AOP",price:2,pk:"9–16 €/kg",name:{en:"Grenoble walnut",fr:"Noix de Grenoble"},latin:"Juglans regia (Franquette)",
...
{id:"japanese-chestnut",cat:"nuts",parent:"chestnut",rare:true,price:2,pk:"15–30 €/kg",name:{en:"Japanese chestnut",fr:"Châtaigne japonaise (kuri)"},latin:"Castanea crenata",
...
{id:"korean-pine-nut",cat:"nuts",parent:"pine-nut",price:3,pk:"40–70 €/kg",name:{en:"Korean pine nut",fr:"Pignon de pin de Corée"},latin:"Pinus koraiensis",
...
{id:"largueta-almond",cat:"nuts",parent:"almond",price:2,pk:"20–35 €/kg",name:{en:"Largueta almond",fr:"Amande Largueta"},latin:"Prunus dulcis (Desmayo Largueta)",
...
{id:"marcona-almond",cat:"nuts",parent:"almond",price:2,pk:"22–40 €/kg",name:{en:"Marcona almond",fr:"Amande Marcona"},latin:"Prunus dulcis (Marcona)",
...
{id:"piedmont-hazelnut",cat:"nuts",parent:"hazelnut",sign:"IGP",price:3,pk:"30–55 €/kg",name:{en:"Piedmont hazelnut",fr:"Noisette du Piémont"},latin:"Corylus avellana (Tonda Gentile Trilobata)",
...
{id:"pinyon-pine-nut",cat:"nuts",parent:"pine-nut",price:3,pk:"80–150 €/kg",name:{en:"Pinyon pine nut",fr:"Pignon pinyon"},latin:"Pinus edulis",
...
{id:"perigord-walnut",cat:"nuts",parent:"walnut",price:2,pk:"10–18 €/kg",name:{en:"Périgord walnut",fr:"Noix du Périgord"},latin:"Juglans regia",
...
{id:"tombul-hazelnut",cat:"nuts",parent:"hazelnut",price:2,pk:"25–40 €/kg",name:{en:"Tombul hazelnut",fr:"Noisette Tombul (de Giresun)"},latin:"Corylus avellana (Tombul)",
...
{id:"white-poppy-seed",cat:"nuts",parent:"poppy-seed",price:2,pk:"15–25 €/kg",name:{en:"White poppy seed",fr:"Pavot blanc"},latin:"Papaver somniferum",
...
{id:"chataigne-d-ardeche",cat:"nuts",parent:"chestnut",sign:"AOP",price:1,pk:"5–10 €/kg",name:{en:"Ardèche chestnut",fr:"Châtaigne d’Ardèche"},latin:"Castanea sativa (Ardèche local varieties)",
origin:{en:"Ardèche, with a few communes in the Gard and Drôme",fr:"Ardèche, et quelques communes du Gard et de la Drôme"},season:[9,10,11,12],
flavor:["sweet","honeyed","milky","bitter"],texture:["firm","creamy"],
story:{en:"The appellation admits only the old local varieties of Castanea sativa — Comballe, Sardonne, Bouche Rouge and the rest — and rules out hybrids, which is why the fruit is small to medium and its inner skin, the tan, often folds deep into the kernel, sometimes splitting it in two. Fresh nuts sold to the public run at most 100 to the kilo; those meant for drying are dried slowly by warm air no hotter than 50 °C, for at least seven days.",
fr:"L’appellation n’admet que les variétés locales anciennes de Castanea sativa — comballe, sardonne, bouche rouge et les autres — et exclut les hybrides : d’où un fruit petit à moyen, dont la peau intérieure, le tan, pénètre souvent l’amande jusqu’à la partager. Les châtaignes vendues fraîches au consommateur comptent au plus 100 fruits au kilo ; celles destinées au séchage sèchent lentement à l’air chaud, à 50 °C au plus, pendant au moins sept jours."},
tip:{en:"Because the tan runs into the kernel, peel them hot: slit the shell, roast or simmer them for about twenty minutes, then peel a few at a time under a towel, before the inner skin sets back onto the flesh. Keep fresh ones in the fridge, not the fruit bowl.",
fr:"Le tan entrant dans l’amande, épluchez-les chaudes : incisez la coque, faites-les rôtir ou frémir une vingtaine de minutes, puis pelez-les quelques-unes à la fois sous un torchon, avant que la peau intérieure ne se recolle à la chair. Gardez les fraîches au réfrigérateur, pas dans la corbeille."},
pairs:["turkey","pork","porcini","cream","butter","celeriac","sage","dark-chocolate"],
svg:'<path class="f1 sf" d="M28 40q-13 6-13 20 0 10 11 12h10q10-2 10-12-2-13-18-20z"/><path class="f2 sf" d="M54 24q-21 10-22 30 0 12 15 14h15q15-2 15-14-2-20-23-30z"/><path class="f1 sf" d="M38 62q16 8 32 0 0 4-1 7-15 7-31 0 0-3 0-7z"/><path class="s" d="M54 24q-4-6-8-9M54 24q0-8-1-9M54 24q5-6 9-7M28 40q-2-6-4-7" stroke-width="2"/><path class="s" d="M44 34q-7 8-7 18" stroke-width="1.5"/>'},
{id:"chataigne-des-cevennes",cat:"nuts",parent:"chestnut",sign:"AOP",price:1,pk:"6–7 €/kg",name:{en:"Cévennes chestnut",fr:"Châtaigne des Cévennes"},latin:"Castanea sativa (Cévennes local varieties)",
origin:{en:"Cévennes: Gard, Hérault and Lozère",fr:"Cévennes : Gard, Hérault et Lozère"},season:[9,10,11,12],
flavor:["sweet","honeyed","milky","floral"],texture:["tender","smooth"],
story:{en:"The appellation names thirty local varieties, from Pellegrine to Marron dauphine, and growers keep several in one orchard: the earliest fall from 1 September, the latest by 15 December. The nuts are gathered only once they drop, and no chemical insecticide may be used on them after harvest. For the dried châtaignon they are dried in the shell at no more than 60 °C, and the flour must pass 80% through a 250-micron sieve, which is why it melts rather than grits.",
fr:"L’appellation nomme trente variétés locales, de la pellegrine au marron dauphine, et les castanéiculteurs en gardent plusieurs par verger : les plus précoces tombent dès le 1er septembre, les plus tardives jusqu’au 15 décembre. On ne les ramasse qu’après leur chute naturelle, et toute désinsectisation chimique après récolte est interdite. Pour le châtaignon, elles sèchent dans leur peau à 60 °C au plus, et la farine doit passer à 80 % au tamis de 250 µm : de là sa texture fondante, sans grain."},
tip:{en:"No chemical insecticide is allowed after harvest, so sort them the day you buy them: tip them into cold water, throw out any that float, and keep the rest in the fridge. The flour has no gluten, so blend it with wheat flour for anything that has to rise.",
fr:"Aucune désinsectisation chimique n’est permise après récolte : triez-les le jour de l’achat en les plongeant dans l’eau froide, jetez celles qui flottent et gardez les autres au réfrigérateur. La farine n’a pas de gluten : mêlez-la à de la farine de blé pour tout ce qui doit lever."},
pairs:["pelardon","cevennes-sweet-onion","pork","wild-boar","porcini","chestnut-honey","cream","butter"],
svg:'<path class="f1 sf" d="M28 40q-13 6-13 20 0 10 11 12h10q10-2 10-12-2-13-18-20z"/><path class="f2 sf" d="M54 24q-21 10-22 30 0 12 15 14h15q15-2 15-14-2-20-23-30z"/><path class="f1 sf" d="M38 62q16 8 32 0 0 4-1 7-15 7-31 0 0-3 0-7z"/><path class="s" d="M54 24q-4-6-8-9M54 24q0-8-1-9M54 24q5-6 9-7M28 40q-2-6-4-7" stroke-width="2"/><path class="s" d="M44 34q-7 8-7 18" stroke-width="1.5"/>'}
]);
